...
import FamilyStatsHeader from "@app/components/root/stats/FamilyStatsHeader";
import FamilyStatsList from "@app/components/root/stats/FamilyStatsList";
...
const FamilyStatsPage = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Divider height={60} />
      <FamilyStatsHeader progess={0.65} totalScore={500} />
      <Divider height={24} />
